...
Open the :guilabel:`Filters` drop-down menu by selecting the :icon:`fa-caret-down` :guilabel:`(dropdown)`
...
To filter opportunities by a specific lost reason, select the :icon:`fa-caret-down` :guilabel:`(dropdown)`
...
dashboard. Or, navigate to :menuselection:`CRM app --> Sales --> My Pipeline`. From here, select the :icon:`fa-caret-down` :guilabel:`(dropdown)` icon to the right of the search bar to open the
...
Next, select the list view option, represented by the :icon:`fa-bars` :guilabel:`(list)` icon in the upper-right
...
Once the desired opportunities have been selected, select the :icon:`fa-cog` :guilabel:`(Actions)` drop-down menu
at the top of the :guilabel:`Pipeline` page. From the :icon:`fa-cog` :guilabel:`(Actions)` drop-down menu, select
:guilabel:`Unarchive`.
...
To restore a lost lead, navigate to :menuselection:`CRM app --> Leads`, then select the :icon:`fa-caret-down` :guilabel:`(dropdown)` icon to the right of the search bar to open the drop-down
...
Once the desired leads have been selected, select the :icon:`fa-cog` :guilabel:`(Actions)` drop-down menu at the
top of the :guilabel:`Leads` page. From the :icon:`fa-cog` :guilabel:`(Actions)` drop-down menu, select
:guilabel:`Unarchive`.
