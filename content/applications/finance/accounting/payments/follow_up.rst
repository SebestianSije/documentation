...
:guilabel:`Responsible` person and the :guilabel:`Activity Type`, and enter a :guilabel:`Summary`.
...
.. _accounting/payments-follow-up/follow-ups-for-one-customer:
...
- :guilabel:`Next reminder`: Date by which follow-up actions should be taken. This date is
...
.. _accounting/payments-follow-up/follow-ups-for-all-customers:

Follow-ups for all customers due for action
-------------------------------------------

After setting up the additional :ref:`follow-up
<accounting/payments-follow-up/follow-ups-for-one-customer>` options, review which customers have
...
To take follow-up actions for all relevant customers, click the :icon:`oi-view-list`
:guilabel:`(list view)` icon and select the customers who need follow-up. Then, click
:icon:`fa-cog` :guilabel:`(Actions)` and select :guilabel:`Process Follow-ups`.
